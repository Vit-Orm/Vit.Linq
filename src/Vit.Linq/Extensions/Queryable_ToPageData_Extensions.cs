...
namespace Vit.Extensions.Linq_Extensions
{
    ...
    public static partial class Queryable_ToPageData_Extensions
    {
        ...
        public static PageData<T> ToPageData<T>(this IQueryable<T> query, IEnumerable<OrderField> sort, PageInfo page
        ) where T : class
        {
        ...
        /// <returns></returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PageData<TResult> ToPageData<T, TResult>(this IQueryable<T> query, IEnumerable<OrderField> sort, PageInfo page, Func<T, TResult> selector
        ) where T : class
        {
